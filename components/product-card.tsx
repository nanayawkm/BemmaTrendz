  ...
  return (
    <div className="group relative h-full flex flex-col">
      ...
      <Link href={href} className="block flex-grow">
        <div className="relative mb-4 overflow-hidden rounded-2xl bg-white shadow-md h-[320px]">
          <Image
            ...
            priority
          />
          <button className="absolute right-3 top-3 rounded-full bg-white p-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100 shadow-md hover:bg-gray-50">
            <Heart className="h-5 w-5 text-[#f34f38]" />
          </button>
