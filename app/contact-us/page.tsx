              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f34f38] focus:border-transparent"
                ...
                <Button className="w-full bg-[#f34f38] hover:bg-[#d63a22] text-white">
                  Send Message
                </Button>
              </form>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-[#f34f38] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@bemmatrendz.com</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-[#f34f38] rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8">
            <div>
              ...
              <p className="text-gray-600 text-sm">Specializing in custom Bubu dresses and wig caps with high-quality materials and expert craftsmanship.</p>
            </div>
            <div>
